      ...
      <div className="container">
        <div className="footer-inner">
          ...
          <div className="footer-brand">
            ...
            <p>
              Karadeniz&apos;in incisi Ünye&apos;de, Sahil Yolu&apos;nda sizi bekleyen sıcak bir
              fincan ve unutulmaz bir atmosfer.
            </p>
          </div>
          ...
          <nav aria-label="Footer navigasyon">
            <div className="footer-col">
              ...
              <ul>
                ...
                <li>
                  <a href="#kahvelerimiz">Kahvelerimiz</a>
                </li>
                <li>
          ...
          <div className="footer-col">
            ...
            <ul>
              <li>
                <a href="tel:+904523336111" aria-label="Kahve Ateşi telefon">
                  (0452) 333 61 11
                </a>
              </li>
              <li>
        ...
        <div className="footer-bottom">
          <p className="footer-copy">© {year} Kahve Ateşi. Tüm hakları saklıdır.</p>
          <p className="footer-copy">Çamurlu, Devlet Sahil Yolu No:32, 52300 Ünye / Ordu</p>
        </div>
      </div>
    </footer>
  );
